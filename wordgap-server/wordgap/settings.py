# Django settings for wordgap project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'sessions_sqlite3.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '^c4pjj+n+p%84wk&amp;1!dh+y*702om(xj95$rh$ffkbvsvj5)z#1'
...
ROOT_URLCONF = 'wordgap.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'wordgap.wsgi.application'
