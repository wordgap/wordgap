...
public class NewExActivity extends Activity {
	...
	protected Dialog onCreateDialog(int id) {
		...
		case DIALOG_NO_NETWORK:
			...
			builder.setMessage("Das Netzwerk ist deaktiviert! Bitte überprüfe deine "
					+ "Netzwerkeinstellungen und versuche es später noch einmal!");
			builder.setPositiveButton("OK",
					new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int which) {

							final Intent i = new Intent(thisActivity,
									WordgapMainMenuActivity.class);
							startActivity(i);
						}
					});
			return builder.show();
		case DIALOG_NO_TEXT:
			builder.setTitle("Fehler");
			builder.setMessage("Der Text konnte nicht geladen werden oder ist nicht lang genug! (Mindestlänge: "
					+ "300 Wörter)");
			builder.setPositiveButton("OK",
					new DialogInterface.OnClickListener() {
						@Override
	...
	protected class LoadExTask extends AsyncTask<String, Void, ArrayList<Sent>> {
		...
		protected ArrayList<Sent> doInBackground(String... params) {
			...
			final String filename = title + "_" + pos + ".json";
		...
		protected void onPostExecute(ArrayList<Sent> ex) {
			...
			if (io == null) {
				...
				app.setPos(pos);
				app.setEx(ex);
				final Intent i = new Intent(thisActivity, GameActivity.class);
				startActivity(i);
			} else {
