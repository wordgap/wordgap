...
//Read text from file
        ...
        try {
            ...
            new AlertDialog.Builder(this).setTitle(R.string.error_file).setPositiveButton("OK", new DialogInterface.OnClickListener() {
                @Override
    ...
    private void getDir(String dirPath) {
        ...
        myPath.setText(getString(R.string.dir) + dirPath);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if(file.isDirectory()) {
            if(file.canRead()) {
                ...
                new AlertDialog.Builder(this)
                        .setTitle(getString(R.string.error_file) + " " + file.getName()).setPositiveButton("OK", new DialogInterface.OnClickListener() {
        ...
        // wenn lesbare Datei:
            ...
            new AlertDialog.Builder(this)
                    .setTitle(getString(R.string.new_ex) + file.getName() + "?").setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
